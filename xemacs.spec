...
Requires: xemacs-data = %{version}-%{release}
Requires: xemacs-libexec = %{version}-%{release}
Requires: xemacs-license = %{version}-%{release}
Requires: xemacs-man = %{version}-%{release}
Requires: emacs
...
%package dev
Summary: dev components for the xemacs package.
Group: Development
Requires: xemacs-bin = %{version}-%{release}
Requires: xemacs-data = %{version}-%{release}
Provides: xemacs-devel = %{version}-%{release}
Requires: xemacs = %{version}-%{release}

%description dev
dev components for the xemacs package.
...
%package libexec
Summary: libexec components for the xemacs package.
Group: Default
Requires: xemacs-license = %{version}-%{release}

%description libexec
libexec components for the xemacs package.


%package license
Summary: license components for the xemacs package.
Group: Default

%description license
license components for the xemacs package.
...
cp etc/COPYING %{buildroot}/usr/share/package-licenses/xemacs/etc_COPYING
cp leim/COPYING %{buildroot}/usr/share/package-licenses/xemacs/leim_COPYING
cp lib-src/COPYING %{buildroot}/usr/share/package-licenses/xemacs/lib-src_COPYING
cp lib/COPYING %{buildroot}/usr/share/package-licenses/xemacs/lib_COPYING
cp lisp/COPYING %{buildroot}/usr/share/package-licenses/xemacs/lisp_COPYING
cp lwlib/COPYING %{buildroot}/usr/share/package-licenses/xemacs/lwlib_COPYING
cp msdos/COPYING %{buildroot}/usr/share/package-licenses/xemacs/msdos_COPYING
cp nt/COPYING %{buildroot}/usr/share/package-licenses/xemacs/nt_COPYING
cp src/COPYING %{buildroot}/usr/share/package-licenses/xemacs/src_COPYING
%make_install
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/xemacs/COPYING
/usr/share/package-licenses/xemacs/etc_COPYING
/usr/share/package-licenses/xemacs/leim_COPYING
/usr/share/package-licenses/xemacs/lib-src_COPYING
/usr/share/package-licenses/xemacs/lib_COPYING
/usr/share/package-licenses/xemacs/lisp_COPYING
/usr/share/package-licenses/xemacs/lwlib_COPYING
/usr/share/package-licenses/xemacs/msdos_COPYING
/usr/share/package-licenses/xemacs/nt_COPYING
/usr/share/package-licenses/xemacs/src_COPYING
